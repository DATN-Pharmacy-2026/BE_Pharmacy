...
export function validateEnv(
  ...
  const schema = Joi.object({
    ...
    ENABLE_REQUEST_LOGGING: Joi.boolean()
      ...
      .falsy('false')
      .default(true),
    EVENT_RETRY_ENABLED: Joi.boolean()
      .truthy('true')
      .falsy('false')
      .default(true),
    ...
    EVENT_DLQ_PAYLOAD_PREVIEW_MAX_CHARS: Joi.number()
      .integer()
      .min(200)
      .default(4000),
    EVENT_ADMIN_ENDPOINTS_ENABLED: Joi.boolean()
      .truthy('true')
      .falsy('false')
      .default(true),
  })
