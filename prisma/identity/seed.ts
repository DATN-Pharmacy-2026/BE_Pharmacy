...
const ROLE_PERMISSIONS: Record<RoleCode, string[]> = {
  ...
  COMPANY_ADMIN: [
    'admin.access',
    'user.view', 'user.create', 'user.update', 'user.disable', 'user.assign_role', 'user.assign_scope', 'user.reset_password',
  ...
  CUSTOMER_SERVICE: ['admin.access', 'user.view', 'order.view', 'order.update', 'payment.view', 'notification.view', 'notification.manage'],
