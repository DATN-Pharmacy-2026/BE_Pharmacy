  ...
  private buildDefaultTemplates() {
    ...
    for (const channel of byChannels) {
      rows.push({
        ...
        channel,
        locale,
        subject: 'Bao cao da san sang',
        titleTemplate: 'Bao cao da xuat xong',
        messageTemplate: 'Bao cao {{reportType}} da duoc xuat thanh cong. Ban co the tai tai {{downloadUrl}}.',
        htmlTemplate: '<p>Bao cao <strong>{{reportType}}</strong> da duoc xuat thanh cong. Tai: {{downloadUrl}}</p>',
      ...
      rows.push({
        ...
        channel,
        locale,
        subject: 'Xuat bao cao that bai',
        titleTemplate: 'Xuat bao cao that bai',
        messageTemplate: 'Bao cao {{reportType}} xuat that bai. Ly do: {{errorMessage}}.',
        htmlTemplate: '<p>Bao cao <strong>{{reportType}}</strong> that bai. Ly do: {{errorMessage}}</p>',
    ...
    rows.push(
      {
        ...
        titleTemplate: 'Ton kho thap',
        messageTemplate: 'San pham {{productName}} tai chi nhanh/kho {{branchId}}{{warehouseId}} dang duoi nguong ton kho.',
        htmlTemplate: null,
      ...
      },
      {
        ...
        channel: NotificationChannel.IN_APP,
        locale,
        subject: 'Cau hinh he thong da thay doi',
        titleTemplate: 'Cau hinh da thay doi',
        messageTemplate: 'Cau hinh {{settingKey}} da duoc cap nhat.',
        htmlTemplate: null,
      ...
      },
      {
        ...
        messageTemplate: '{{actorUserId}} da thuc hien {{action}} tren {{entityType}}.',
        htmlTemplate: null,
